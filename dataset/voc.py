...
class VOCSegmentation(data.Dataset):
    ...
    def __init__(self,
        ...
        splits_dir = '/scratch/kona419/Incrementer/VOCdevkit/VOC2012/splits'
        ...
        with open(os.path.join(split_f), "r") as f:
            file_names = [x.strip().split(' ') for x in f.readlines()]
...
class VOCSegmentationIncremental(data.Dataset):
    def __init__(self,
        ...
        if labels is not None:
            ...
            self.inverted_order[255] = self.masking_value
    ...
    def target_transform_func(self, t):
        ...
        return t.apply_(lambda x: self.inverted_order[x] if x in tmp_labels else self.masking_value)
    
    def reorder_transform_func(self, t):
        return t.apply_(lambda x: self.inverted_order[x] if x in self.inverted_order else self.masking_value)
